<template>
  <nav class="sticky top-0 z-10 flex items-center justify-between flex-wrap bg-white p-6">
    ...
    <div class="w-full block flex-grow md:flex md:items-center md:w-auto">
      ...
      <div class="relative mx-auto flex items-center rounded-lg overflow-hidden text-gray-600 border-2 border-gray-300 bg-white">
        <input
          class="h-10 px-5 text-sm focus:outline-none"
          type="search"
          name="search"
          placeholder="Search"
        />
        <button type="submit" class="flex items-center justify-center h-10 w-10">
          <svg
